...
public interface JwWebJwidDao extends GenericDao<WeixinAccountDto>{
	 ...
	 * @return
	 */
	public WeixinAccountDto queryJwidNameByJwid(@Param("jwid") String jwid);
	 ...
	 * @return
	 */
	public List<WeixinAccountDto> queryJwWebJwidByUserId(@Param("userId") String userId);
	 ...
	 * @return
	 */
	public List<WeixinAccountDto> queryJwidsNotInUser(@Param("userId") String userId);
	 ...
	 * @param userId
	 */
	public void deleteUserJwidByUserid(@Param("userId") String userId);
}
